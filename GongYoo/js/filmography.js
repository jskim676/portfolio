function filmographyTitle () {
  ...
  const select = (target, opponent, angle, appear, disappear, number) => {
    target.addEventListener('click',function() {
      filmographySelect.children[0].style.transition = "0.5s";
      ...
      filmographySelect.children[2].style.transition = "0.5s";
  ...
  let rotate = 0;
  filmographySelect.children[1].addEventListener('click', e => {
    if(rotate === 0) {
      filmographySelect.children[0].style.transition = "0.5s";
